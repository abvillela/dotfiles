...
xnoremap <silent>  maw :call multiple_cursors#select_all("v", 0)
nnoremap <silent>  maw :call multiple_cursors#select_all("n", 1)
xnoremap <silent>  mak :call multiple_cursors#select_all("v", 0)
nnoremap <silent>  mak :call multiple_cursors#select_all("n", 0)
xnoremap <silent>  mw :call multiple_cursors#new("v", 0)
nnoremap <silent>  mw :call multiple_cursors#new("n", 1)
xnoremap <silent>  mk :call multiple_cursors#new("v", 0)
nnoremap <silent>  mk :call multiple_cursors#new("n", 0)
...
nmap  bp :BB " prev buffer
nmap  bn :BF " next buffer
nmap  bd :BD " delete a file from buffer and keep window/split
nmap  fs :ALEFixSuggest " Ale suggest fixes
nmap  ff :ALEFix " Ale lint and fix
nmap  /br :cdo %s///g | update
nmap  /dtx :Ack! --tsx ""<Left>
nmap  /dt :Ack! --ts ""<Left>
nmap  /djn :Ack! --json ""<Left>
nmap  /dj :Ack! --js ""<Left>
nmap  /dm :Ack! --md ""<Left>
nmap  /dh :Ack! --html ""<Left>
nmap  /ds :Ack! --sass ""<Left>
nmap  /dc :Ack! --css ""<Left>
nmap  /b :Ack "" %<Left><Left><Left>
nmap  /a :Ack ""<Left>
map  td :bd
map  tp :bp
map  tn :bn
...
imap  <Plug>Isurround
imap  ct <Plug>NERDCommenterToggle " toggle comment selection
imap  cc <Plug>NERDCommenterComment " comment selection
...
set runtimepath+=~/.vim/pack/themes/start/dracula_pro
set runtimepath+=/usr/local/Cellar/macvim/8.2-166_2/MacVim.app/Contents/Resources/vim/vimfiles
set runtimepath+=/usr/local/Cellar/macvim/8.2-166_2/MacVim.app/Contents/Resources/vim/runtime
set runtimepath+=~/.vim/pack/themes/start/dracula_pro/after
set runtimepath+=/usr/local/Cellar/macvim/8.2-166_2/MacVim.app/Contents/Resources/vim/vimfiles/after
